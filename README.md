...
```javascript
str2enum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-matrix-triangle-str2enum@v0.1.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-base-matrix-triangle-str2enum/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/blas-base-matrix-triangle-str2enum/actions/workflows/test.yml?query=branch:v0.1.2
